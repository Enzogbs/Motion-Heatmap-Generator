...
def prepare_parser():
    ...
    # Colormap
    parser.add_argument("-c", "--colormap", action="store", dest="cmap",
                        help="Colormap to apply in the heatmap. Default: cv2.COLORMAP_TURBO",
                        required=False, default="TURBO", choices=["TURBO", "JET", "HOT", "COOL", "SPRING", "WINTER", "RAINBOW", "OCEAN", "BONE", "PLAID", "HSV", "PARULA"])
